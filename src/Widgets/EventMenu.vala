...
public class Maya.EventMenu : Gtk.Menu {
    ...
    private void remove_event () {
        ...
        event_store.component_remove (comp.get_data<E.Source> ("source"), comp, ECal.ObjModType.ALL);
    }

    private void add_exception () {
        var event_store = Calendar.Store.get_event_store ();
        event_store.component_remove (comp.get_data<E.Source> ("source"), comp, ECal.ObjModType.THIS);
    }
}
