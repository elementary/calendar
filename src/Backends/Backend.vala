...
public interface Maya.Backend : GLib.Object {
    ...
    public abstract Gtk.Widget get_new_calendar_widget (E.Source? to_edit = null);
    public abstract void add_new_calendar (string name, string color, Gtk.Widget widget);
}
