/* Backend.c generated by valac 0.34.9, the Vala compiler
...
gchar* maya_backend_get_name (MayaBackend* self) {
#line 24 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 24 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	return MAYA_BACKEND_GET_INTERFACE (self)->get_name (self);
#line 78 "Backend.c"
}


gchar* maya_backend_get_uid (MayaBackend* self) {
#line 25 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 25 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	return MAYA_BACKEND_GET_INTERFACE (self)->get_uid (self);
#line 87 "Backend.c"
}


GeeCollection* maya_backend_get_new_calendar_widget (MayaBackend* self, ESource* to_edit) {
#line 26 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 26 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	return MAYA_BACKEND_GET_INTERFACE (self)->get_new_calendar_widget (self, to_edit);
#line 96 "Backend.c"
}


void maya_backend_add_new_calendar (MayaBackend* self, const gchar* name, const gchar* color, gboolean set_default, GeeCollection* widgets) {
#line 27 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	g_return_if_fail (self != NULL);
#line 27 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	MAYA_BACKEND_GET_INTERFACE (self)->add_new_calendar (self, name, color, set_default, widgets);
#line 105 "Backend.c"
}


void maya_backend_modify_calendar (MayaBackend* self, const gchar* name, const gchar* color, gboolean set_default, GeeCollection* widgets, ESource* source) {
#line 28 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	g_return_if_fail (self != NULL);
#line 28 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
	MAYA_BACKEND_GET_INTERFACE (self)->modify_calendar (self, name, color, set_default, widgets, source);
#line 114 "Backend.c"
}


static void maya_backend_base_init (MayaBackendIface * iface) {
#line 23 "/home/cassidyjames/Projects/elementary/calendar/core/Backends/Backend.vala"
...
GType maya_backend_get_type (void) {
	static volatile gsize maya_backend_type_id__volatile = 0;
	if (g_once_init_enter (&maya_backend_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof (MayaBackendIface), (GBaseInitFunc) maya_backend_base_init, (GBaseFinalizeFunc) NULL, (GClassInitFunc) NULL, (GClassFinalizeFunc) NULL, NULL, 0, 0, (GInstanceInitFunc) NULL, NULL };
		GType maya_backend_type_id;
		maya_backend_type_id = g_type_register_static (G_TYPE_INTERFACE, "MayaBackend", &g_define_type_info, 0);
		g_type_interface_add_prerequisite (maya_backend_type_id, G_TYPE_OBJECT);
		g_once_init_leave (&maya_backend_type_id__volatile, maya_backend_type_id);
	}
	return maya_backend_type_id__volatile;
}
