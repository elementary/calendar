/* maya-calendar.vapi generated by valac 0.24.0, do not modify. */
...
namespace Maya {
	...
	namespace Util {
		...
		[CCode (cheader_filename = "maya-calendar.h")]
		public static iCal.TimeType date_time_to_ical (GLib.DateTime date, GLib.DateTime? time);
		[CCode (cheader_filename = "maya-calendar.h")]
		...
		[CCode (cheader_filename = "maya-calendar.h")]
		public static GLib.DateTime ecal_to_date_time (E.CalComponentDateTime date);
		[CCode (cheader_filename = "maya-calendar.h")]
		public static Gee.Collection<Maya.Util.DateRange> event_date_ranges (E.CalComponent event, Maya.Util.DateRange view_range);
		[CCode (cheader_filename = "maya-calendar.h")]
		...
		[CCode (cheader_filename = "maya-calendar.h")]
		public static bool is_multiday_event (E.CalComponent event);
		[CCode (cheader_filename = "maya-calendar.h")]
		public static bool is_the_all_day (GLib.DateTime dtstart, GLib.DateTime dtend);
		[CCode (cheader_filename = "maya-calendar.h")]
		...
		[CCode (cheader_filename = "maya-calendar.h")]
		public static void zip<F,G> (Gee.Iterable<F> iterable1, Gee.Iterable<G> iterable2, ref Gee.Map<F,G> map);
		[CCode (cheader_filename = "maya-calendar.h")]
	...
	public class Threads {
		...
		public static bool add (Maya.Threads.TaskFunc task);
	}
	[CCode (cheader_filename = "maya-calendar.h")]
